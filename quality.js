/* blissolic.xyz — hardware-adaptive quality.
   ...
   the effects it owns, bats.js reads it for how many bats to spawn.
...
(() => {
  ...
  window.addEventListener(
    "mp:enter",
    () => {
      // wait out the entrance: the reveal and the swarm are the heaviest two
